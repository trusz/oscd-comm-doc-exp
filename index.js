...
function Z(t, e) {
  const n = t.$$;
  n.fragment !== null && (K(n.after_update), x(n.on_destroy), n.fragment && n.fragment.d(e), n.on_destroy = n.fragment = null, n.ctx = []);
}
function tt(t, e) {
...
function et(t, e, n, i, c, o, s = null, l = [-1]) {
  ...
  }) : [], r.update(), E = !0, x(r.before_update), r.fragment = i ? i(r.ctx) : !1, e.target) {
    if (e.hydrate) {
      const u = D(e.target);
...
const M = "oscd-comm-doc-exp", T = "0.0.1";
function L(t) {
  let e;
  return {
    c() {
      e = k("h2"), e.textContent = "Welcome to oscd-comm-doc-exp";
    },
    m(n, i) {
      m(n, e, i);
    },
